...
export default function RestaurantMenuPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#080403] text-neutral-100 flex flex-col items-center justify-between select-none overflow-x-hidden">
      {/* 1. Full-page Ambient WebGL Auralis Background with Glowing Light and Film Grain */}
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <Auralis height="100vh" speed={0.9} intensity={1.05} className="h-full w-full opacity-75" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#080403]/40 via-transparent to-[#080403]/80" />
      </div>
