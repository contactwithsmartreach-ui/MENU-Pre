  ...
  return (
    <>
      ...
      <Dialog open={activeModal === "privacy"} onOpenChange={(open) => !open && onClose()}>
        <DialogContent className="sm:max-w-xl bg-[#0c0605] text-white border-orange-500/40 rounded-3xl p-6 shadow-[0_25px_60px_rgba(239,68,68,0.25)] max-h-[85vh] overflow-y-auto">
          ...
          <div className="py-4 space-y-4 text-xs text-neutral-300 leading-relaxed font-light">
