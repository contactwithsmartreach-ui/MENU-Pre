            ...
            >
              <div className="space-y-5 pt-16">
                ...
                <button
                  ...
                  className="group flex items-center justify-between w-full p-3.5 rounded-2xl bg-white border border-green-500/40 hover:border-green-500 transition-all cursor-pointer shadow-sm text-left"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-green-500/25 border border-green-500/40 flex items-center justify-center text-green-700 shrink-0">
                ...
                <button
                  ...
                  className="group flex items-center justify-between w-full p-3.5 rounded-2xl bg-white border border-orange-500/30 hover:border-orange-500 transition-all cursor-pointer shadow-sm text-left"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-orange-500/25 border border-orange-500/40 flex items-center justify-center text-orange-600 shrink-0">
                ...
                <button
                  ...
                  className="group flex items-center justify-between w-full p-3.5 rounded-2xl bg-white border border-sky-500/30 hover:border-sky-500 transition-all cursor-pointer shadow-sm text-left"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-sky-500/25 border border-sky-500/40 flex items-center justify-center text-sky-600 shrink-0">
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <button
                      ...
                      className="flex items-center gap-2 p-2.5 rounded-xl bg-white border border-orange-500/25 hover:border-orange-500/60 transition-all cursor-pointer text-left shadow-sm"
                    >
