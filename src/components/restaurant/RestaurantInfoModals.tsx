...
export function RestaurantInfoModals({ activeModal, onClose }: RestaurantInfoModalsProps) {
  ...
  return (
    <>
        ...
        <DialogContent className="sm:max-w-md bg-[#e3efed] text-neutral-900 border-orange-500/30 rounded-3xl p-6 shadow-[0_25px_60px_rgba(249,115,22,0.2)]">
          <DialogHeader className="space-y-2 border-b border-orange-500/20 pb-4 text-left">
            <div className="flex items-center gap-2 text-orange-600">
              ...
              <span className="text-xs uppercase font-serif tracking-[0.2em] font-bold">Operating Hours</span>
            </div>
          ...
          <div className="py-4 space-y-3">
            <div className="flex items-center justify-between p-3 rounded-2xl bg-white/80 border border-orange-500/20 shadow-sm">
              <span className="text-sm font-serif text-neutral-800 font-semibold">Monday - Thursday</span>
              <span className="text-xs font-mono text-orange-600 font-bold">5:00 PM - 11:00 PM</span>
            </div>
            <div className="flex items-center justify-between p-3 rounded-2xl bg-white/80 border border-orange-500/20 shadow-sm">
              <span className="text-sm font-serif text-neutral-800 font-semibold">Friday - Saturday</span>
              <span className="text-xs font-mono text-orange-600 font-bold">4:30 PM - 12:00 AM</span>
            </div>
            <div className="flex items-center justify-between p-3 rounded-2xl bg-white/80 border border-orange-500/20 shadow-sm">
              <span className="text-sm font-serif text-neutral-800 font-semibold">Sunday (Brunch & Dinner)</span>
              <span className="text-xs font-mono text-orange-600 font-bold">12:00 PM - 10:00 PM</span>
            </div>
            ...
            <div className="p-3.5 rounded-2xl bg-green-500/10 border border-green-500/30 flex items-center justify-between mt-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-green-700">Currently Open & Taking Orders</span>
              </div>
              <a
                href="tel:0659242630"
      ...
      {/* 2. Full Map & Road Navigation Modal */}
        ...
        <DialogContent className="sm:max-w-2xl bg-[#e3efed] text-neutral-900 border-orange-500/30 rounded-3xl p-6 shadow-[0_25px_60px_rgba(249,115,22,0.2)] overflow-hidden">
          <DialogHeader className="space-y-1 border-b border-orange-500/20 pb-4 text-left">
            <div className="flex items-center gap-2 text-orange-600">
              ...
              <span className="text-xs uppercase font-serif tracking-[0.2em] font-bold">Sanctuary Location & Roads</span>
            </div>
            <DialogTitle className="text-xl font-serif font-bold text-orange-600">
        ...
        <DialogContent className="sm:max-w-sm bg-[#e3efed] text-neutral-900 border-orange-500/30 rounded-3xl p-6 shadow-[0_25px_60px_rgba(249,115,22,0.2)] text-center">
          ...
          <div className="py-6 flex flex-col items-center justify-center space-y-4">
            ...
            <div className="space-y-1 w-full bg-white/80 p-3 rounded-2xl border border-orange-500/20 shadow-sm">
              <p className="text-xs text-neutral-600">Network Name: <strong className="text-neutral-900 font-mono">Sahara_Guest_5G</strong></p>
              <p className="text-xs text-neutral-600">Password: <strong className="text-orange-600 font-mono">saharavip2025</strong></p>
            </div>
